...
<html>
    ...
    <body>
        <div id="interface">
            ...
            <h3 id="cadastro">Cadastrar Aluno</h3>
            <form  method="post" action="inserir.php">

                <fieldset id="usuario"><legend>Identificação do Aluno</legend>

                    <label for="cNome">Nome: </label>
                    <input type="text" required="" name="nome" id="cNome" size="20" maxlength="30" placeholder="Nome Completo"/><br>
                    <label for="cEmail">E-mail:</label>
                    <input type="email" required="" name="email" id="cEmail" size="20" maxlength="30" placeholder="@gmail.com"/><br>
                    ...
                    $sql = "select renda.id, renda.valor from renda order by id";
                    ...
                    <select required="" name="renda_id" id="rf">
                        ...
                        while ($linha = mysqli_fetch_array($retorno)) {
                            ...
                            <option value="<?= $linha['id'] ?>"><?= $linha['valor'] ?></option>
                ...
                <fieldset>
                    ...
                    <input type="text" required="" name="bairro" id="bai"><br>
                    <label for="cRua">Rua:</label>
                    <input type="text" required="" name="rua" id="cRua"><br>
